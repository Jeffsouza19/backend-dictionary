...
<head>
    ...
    <title>Dictionary Documentation</title>
                        ...
                        <div title="Authenticating requests" id="toc-item-authenticating-requests"
                            ...
                            <a href="#authenticating-requests"
                               class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0">Authenticating requests</a>
                                    ...
                                    <div class="expandable">
                        <div title="Auth Routes" id="toc-item-auth-routes"
                             class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-4 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none">
                            <a href="#auth-routes"
                               class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0">Auth Routes</a>
                                    ...
                                    <svg aria-hidden="true" focusable="false" data-prefix="fas"
                                        ...
                                        <div class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-8 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none"
                                             id="toc-item-auth-routes-POSTauth-signin">
                                            <div class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0" title="SignIn Route">
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#auth-routes-POSTauth-signin">
                                                    SignIn Route
                                                </a>
                                            </div>
                                                                                    </div>
                                                                    ...
                                                                    <div class="expandable">
                                        <div class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-8 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none"
                                             id="toc-item-auth-routes-POSTauth-signup">
                                            <div class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0" title="SignUp Route">
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#auth-routes-POSTauth-signup">
                                                    SignUp Route
                                                </a>
                                            </div>
                                                                                    </div>
                                    ...
                                    <div class="expandable">
                        <div title="Dictionary Routes" id="toc-item-dictionary-routes"
                             class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-4 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none">
                            <a href="#dictionary-routes"
                               class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0">Dictionary Routes</a>
                                                            <div class="sl-flex sl-items-center sl-text-xs expansion-chevrons">
                                    <svg aria-hidden="true" focusable="false" data-prefix="fas"
                                         data-icon="chevron-right"
                                         class="svg-inline--fa fa-chevron-right fa-fw sl-icon sl-text-muted"
                                                ...
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#dictionary-routes-GETentries-en">
                                                    List Route
                                                                    ...
                                                                    <div class="expandable">
                                        <div class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-8 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none"
                                             id="toc-item-dictionary-routes-GETentries-en--word-">
                                            <div class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0" title="View Word definitions Route">
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#dictionary-routes-GETentries-en--word-">
...
<p>You can retrieve your token by visiting your dashboard and clicking <b>Generate API token</b>.</p>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--5 sl-flex sl-flex-row sl-items-center">
                <h2 class="sl-text-3xl sl-leading-tight sl-font-prose sl-text-heading sl-mt-5 sl-mb-1"
                    id="auth-routes-POSTauth-signin">
                    SignIn Route
                </h2>
            </div>
        </div>
        ...
        <div class="sl-relative">
            <div title="http://localhost/auth/signin"
                ...
                >
                        ...
                        <div class="sl-flex-1 sl-font-semibold">/auth/signin</div>
                    </div>
...
print_r(json_decode((string) $body));</code></pre>                                        </div>
                                    ...
                                    <div class="sl--ml-2">
                                        <div class="sl-h-sm sl-text-base sl-font-medium sl-px-1.5 sl-text-muted sl-rounded sl-border-transparent sl-border">
                                            ...
                                            <div class="sl-mb-2 sl-inline-block">
                                                <select
                                                        class="example-response-POSTauth-signin-toggle sl-text-base"
                                                        aria-label="Response sample"
                                                        onchange="switchExampleResponse('POSTauth-signin', event.target.value);">
                                        ...
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="copy"
                                            ...
                                            <path fill="currentColor"
                                                  d="M384 96L384 0h-112c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48H464c26.51 0 48-21.49 48-48V128h-95.1C398.4 128 384 113.6 384 96zM416 0v96h96L416 0zM192 352V128h-144c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48h192c26.51 0 48-21.49 48-48L288 416h-32C220.7 416 192 387.3 192 352z"></path>
                                                            ...
                                                            <div class="sl-panel__content-wrapper sl-bg-canvas-100 example-response-POSTauth-signin example-response-POSTauth-signin-0"
                                     style=" "
                                >
    ...
    &quot;token&quot;: &quot;Bearer *token*&quot;
                                                            ...
                                                            <div class="sl-panel__content-wrapper sl-bg-canvas-100 example-response-POSTauth-signin example-response-POSTauth-signin-1"
                                     style=" display: none;"
                                >
                                    <div class="sl-panel__content sl-p-0">                                                                                                                                
                                            <pre><code style="max-height: 300px;"
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--5 sl-flex sl-flex-row sl-items-center">
                <h2 class="sl-text-3xl sl-leading-tight sl-font-prose sl-text-heading sl-mt-5 sl-mb-1"
                    id="auth-routes-POSTauth-signup">
                    SignUp Route
                </h2>
            </div>
        </div>
        ...
        <div class="sl-relative">
            <div title="http://localhost/auth/signup"
                     class="sl-stack sl-stack--horizontal sl-stack--3 sl-inline-flex sl-flex-row sl-items-center sl-max-w-full sl-font-mono sl-py-2 sl-pr-4 sl-bg-canvas-50 sl-rounded-lg"
                >
                                            <div class="sl-text-lg sl-font-semibold sl-px-2.5 sl-py-1 sl-text-on-primary sl-rounded-lg"
                             style="background-color: black;"
                        ...
                        <div dir="rtl"
                             class="sl-overflow-x-hidden sl-truncate sl-text-muted">http://localhost</div>
                        <div class="sl-flex-1 sl-font-semibold">/auth/signup</div>
                    </div>
...
print_r(json_decode((string) $body));</code></pre>                                        </div>
                                ...
                                <div class="sl-flex sl-flex-1 sl-items-center sl-py-2">
                                    <div class="sl--ml-2">
                                        <div class="sl-h-sm sl-text-base sl-font-medium sl-px-1.5 sl-text-muted sl-rounded sl-border-transparent sl-border">
                                            ...
                                            <div class="sl-mb-2 sl-inline-block">
                                                <select
                                                        class="example-response-POSTauth-signup-toggle sl-text-base"
                                                        aria-label="Response sample"
                                                        onchange="switchExampleResponse('POSTauth-signup', event.target.value);">
                                                                                                            <option value="0">200</option>
                                                                                                            <option value="1">400</option>
                                                                                                    </select></div>
                                        </div>
                                        ...
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="copy"
                                            ...
                                            <path fill="currentColor"
                                                  d="M384 96L384 0h-112c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48H464c26.51 0 48-21.49 48-48V128h-95.1C398.4 128 384 113.6 384 96zM416 0v96h96L416 0zM192 352V128h-144c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48h192c26.51 0 48-21.49 48-48L288 416h-32C220.7 416 192 387.3 192 352z"></path>
                                                            ...
                                                            <div class="sl-panel__content-wrapper sl-bg-canvas-100 example-response-POSTauth-signup example-response-POSTauth-signup-0"
                                     style=" "
                                >
                                    <div class="sl-panel__content sl-p-0">                                                                                                                                
                                            <pre><code style="max-height: 300px;"
    ...
    &quot;token&quot;: &quot;Bearer *token*&quot;
                                                            ...
                                                            <div class="sl-panel__content-wrapper sl-bg-canvas-100 example-response-POSTauth-signup example-response-POSTauth-signup-1"
                                     style=" display: none;"
                                >
                                    <div class="sl-panel__content sl-p-0">                                                                                                                                
                                            <pre><code style="max-height: 300px;"
                                                       class="language-json sl-overflow-x-auto sl-overflow-y-auto">{
    &quot;errors&quot;: {
        &quot;message&quot;: &quot;N&atilde;o Foi poss&iacute;vel realizar o Login, favor verificar se o email e/ou senha est&atilde;o corretos&quot;
    }
}</code></pre>
                                                                            </div>
                                </div>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        ...
        <div class="sl-relative">
            <div title="http://localhost/entries/en"
                     class="sl-stack sl-stack--horizontal sl-stack--3 sl-inline-flex sl-flex-row sl-items-center sl-max-w-full sl-font-mono sl-py-2 sl-pr-4 sl-bg-canvas-50 sl-rounded-lg"
                >
                                            <div class="sl-text-lg sl-font-semibold sl-px-2.5 sl-py-1 sl-text-on-primary sl-rounded-lg"
                        ...
                        <div dir="rtl"
                             class="sl-overflow-x-hidden sl-truncate sl-text-muted">http://localhost</div>
                        <div class="sl-flex-1 sl-font-semibold">/entries/en</div>
                    </div>
...
print_r(json_decode((string) $body));</code></pre>                                        </div>
                                ...
                                <div class="sl-flex sl-flex-1 sl-items-center sl-py-2">
                                    <div class="sl--ml-2">
                                        <div class="sl-h-sm sl-text-base sl-font-medium sl-px-1.5 sl-text-muted sl-rounded sl-border-transparent sl-border">
                                            ...
                                            <div class="sl-mb-2 sl-inline-block">
                                                <select
                                                        class="example-response-GETentries-en-toggle sl-text-base"
                                                        aria-label="Response sample"
                                                        onchange="switchExampleResponse('GETentries-en', event.target.value);">
                                                                                                            <option value="0">200</option>
                                                                                                    </select></div>
                                        </div>
                                    </div>
                                        ...
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="copy"
                                            ...
                                            <path fill="currentColor"
                                                  d="M384 96L384 0h-112c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48H464c26.51 0 48-21.49 48-48V128h-95.1C398.4 128 384 113.6 384 96zM416 0v96h96L416 0zM192 352V128h-144c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48h192c26.51 0 48-21.49 48-48L288 416h-32C220.7 416 192 387.3 192 352z"></path>
                                                            ...
                                                            <div class="sl-panel__content-wrapper sl-bg-canvas-100 example-response-GETentries-en example-response-GETentries-en-0"
                                     style=" "
                                >
                                    <div class="sl-panel__content sl-p-0">                                                                                                                                
                                            <pre><code style="max-height: 300px;"
    ...
    &quot;totalDocs&quot;: 117,
    &quot;previous&quot;: null,
    &quot;next&quot;: &quot;eyJ3b3JkIjoiaGlzdG9jaGVtaWNhbCIsIl9wb2ludHNUb05leHRJdGVtcyI6dHJ1ZX0&quot;,
    &quot;hasNext&quot;: true,
    &quot;hasPrev&quot;: false
}</code></pre>
                                                                            </div>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--5 sl-flex sl-flex-row sl-items-center">
                <h2 class="sl-text-3xl sl-leading-tight sl-font-prose sl-text-heading sl-mt-5 sl-mb-1"
                    id="dictionary-routes-GETentries-en--word-">
                    View Word definitions Route
                </h2>
            </div>
        </div>
        ...
        <div class="sl-relative">
            <div title="http://localhost/entries/en/{word}"
                     class="sl-stack sl-stack--horizontal sl-stack--3 sl-inline-flex sl-flex-row sl-items-center sl-max-w-full sl-font-mono sl-py-2 sl-pr-4 sl-bg-canvas-50 sl-rounded-lg"
                >
                                            <div class="sl-text-lg sl-font-semibold sl-px-2.5 sl-py-1 sl-text-on-primary sl-rounded-lg"
                             style="background-color: green;"
                        ...
                        <div dir="rtl"
                             class="sl-overflow-x-hidden sl-truncate sl-text-muted">http://localhost</div>
                        <div class="sl-flex-1 sl-font-semibold">/entries/en/{word}</div>
                    </div>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--1 sl-flex sl-flex-1 sl-flex-col sl-items-stretch sl-max-w-full sl-ml-2 ">
        <div class="sl-flex sl-items-center sl-max-w-full">
                                        <div class="sl-flex sl-items-baseline sl-text-base">
                    <div class="sl-font-mono sl-font-semibold sl-mr-2">word</div>
                                            <span class="sl-truncate sl-text-muted">string</span>
                                    </div>
                                    <div class="sl-flex-1 sl-h-px sl-mx-3"></div>
                    <span class="sl-ml-2 sl-text-warning">required</span>
...
print_r(json_decode((string) $body));</code></pre>                                        </div>
                                ...
                                <div class="sl-flex sl-flex-1 sl-items-center sl-py-2">
                                    <div class="sl--ml-2">
                                        <div class="sl-h-sm sl-text-base sl-font-medium sl-px-1.5 sl-text-muted sl-rounded sl-border-transparent sl-border">
                                            ...
                                            <div class="sl-mb-2 sl-inline-block">
                                                <select
                                                        class="example-response-GETentries-en--word--toggle sl-text-base"
                                                        aria-label="Response sample"
                                                        onchange="switchExampleResponse('GETentries-en--word-', event.target.value);">
                                                                                                            <option value="0">200</option>
                                                                                                            <option value="1">400</option>
                                                                                                    </select></div>
                                        </div>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        ...
        <div class="sl-relative">
            <div title="http://localhost/entries/en/{word}/favorite"
                     class="sl-stack sl-stack--horizontal sl-stack--3 sl-inline-flex sl-flex-row sl-items-center sl-max-w-full sl-font-mono sl-py-2 sl-pr-4 sl-bg-canvas-50 sl-rounded-lg"
                >
                                            <div class="sl-text-lg sl-font-semibold sl-px-2.5 sl-py-1 sl-text-on-primary sl-rounded-lg"
                             style="background-color: black;"
                        ...
                        <div dir="rtl"
                             class="sl-overflow-x-hidden sl-truncate sl-text-muted">http://localhost</div>
                        <div class="sl-flex-1 sl-font-semibold">/entries/en/{word}/favorite</div>
                    </div>
...
print_r(json_decode((string) $body));</code></pre>                                        </div>
                                ...
                                <div class="sl-flex sl-flex-1 sl-items-center sl-py-2">
                                    <div class="sl--ml-2">
                                        <div class="sl-h-sm sl-text-base sl-font-medium sl-px-1.5 sl-text-muted sl-rounded sl-border-transparent sl-border">
                                            ...
                                            <div class="sl-mb-2 sl-inline-block">
                                                <select
                                                        class="example-response-POSTentries-en--word--favorite-toggle sl-text-base"
                                                        aria-label="Response sample"
                                                        onchange="switchExampleResponse('POSTentries-en--word--favorite', event.target.value);">
                                                                                                            <option value="0">200</option>
                                                                                                    </select></div>
                                        </div>
                                    </div>
                                        ...
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="copy"
                                            ...
                                            <path fill="currentColor"
                                                  d="M384 96L384 0h-112c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48H464c26.51 0 48-21.49 48-48V128h-95.1C398.4 128 384 113.6 384 96zM416 0v96h96L416 0zM192 352V128h-144c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48h192c26.51 0 48-21.49 48-48L288 416h-32C220.7 416 192 387.3 192 352z"></path>
                                                            ...
                                                            <div class="sl-panel__content-wrapper sl-bg-canvas-100 example-response-POSTentries-en--word--favorite example-response-POSTentries-en--word--favorite-0"
                                     style=" "
                                >
                                    <div class="sl-panel__content sl-p-0">                                                                                                                                
                                            <pre><code style="max-height: 300px;"
                                                       class="language-json sl-overflow-x-auto sl-overflow-y-auto">{
    &quot;word&quot;: &quot;aa&quot;,
    &quot;added&quot;: &quot;2024-10-20T17:04:28.000000Z&quot;
}</code></pre>
                                                                            </div>
                                </div>
                                                    </div>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        ...
        <div class="sl-relative">
            <div title="http://localhost/entries/en/{word}/unfavorite"
                     class="sl-stack sl-stack--horizontal sl-stack--3 sl-inline-flex sl-flex-row sl-items-center sl-max-w-full sl-font-mono sl-py-2 sl-pr-4 sl-bg-canvas-50 sl-rounded-lg"
                >
                                            <div class="sl-text-lg sl-font-semibold sl-px-2.5 sl-py-1 sl-text-on-primary sl-rounded-lg"
                        ...
                        <div dir="rtl"
                             class="sl-overflow-x-hidden sl-truncate sl-text-muted">http://localhost</div>
                        <div class="sl-flex-1 sl-font-semibold">/entries/en/{word}/unfavorite</div>
                    </div>
                                ...
                                <div class="sl-flex sl-flex-1 sl-items-center sl-py-2">
                                    <div class="sl--ml-2">
                                        <div class="sl-h-sm sl-text-base sl-font-medium sl-px-1.5 sl-text-muted sl-rounded sl-border-transparent sl-border">
                                            ...
                                            <div class="sl-mb-2 sl-inline-block">
                                                <select
                                                        class="example-response-DELETEentries-en--word--unfavorite-toggle sl-text-base"
                                                        aria-label="Response sample"
                                                        onchange="switchExampleResponse('DELETEentries-en--word--unfavorite', event.target.value);">
                                        ...
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="copy"
                                            ...
                                            <path fill="currentColor"
                                                  d="M384 96L384 0h-112c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48H464c26.51 0 48-21.49 48-48V128h-95.1C398.4 128 384 113.6 384 96zM416 0v96h96L416 0zM192 352V128h-144c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48h192c26.51 0 48-21.49 48-48L288 416h-32C220.7 416 192 387.3 192 352z"></path>
                                                            ...
                                                            <div class="sl-panel__content-wrapper sl-bg-canvas-100 example-response-DELETEentries-en--word--unfavorite example-response-DELETEentries-en--word--unfavorite-0"
                                     style=" "
                                >
...
print_r(json_decode((string) $body));</code></pre>                                        </div>
                                ...
                                <div class="sl-flex sl-flex-1 sl-items-center sl-py-2">
                                    <div class="sl--ml-2">
                                        <div class="sl-h-sm sl-text-base sl-font-medium sl-px-1.5 sl-text-muted sl-rounded sl-border-transparent sl-border">
                                            ...
                                            <div class="sl-mb-2 sl-inline-block">
                                                <select
                                                        class="example-response-GET--toggle sl-text-base"
                                                        aria-label="Response sample"
                                                        onchange="switchExampleResponse('GET-', event.target.value);">
                                                                                                            <option value="0">200</option>
                                                                                                    </select></div>
                                        </div>
                                    </div>
                                        ...
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="copy"
                                            ...
                                            <path fill="currentColor"
                                                  d="M384 96L384 0h-112c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48H464c26.51 0 48-21.49 48-48V128h-95.1C398.4 128 384 113.6 384 96zM416 0v96h96L416 0zM192 352V128h-144c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48h192c26.51 0 48-21.49 48-48L288 416h-32C220.7 416 192 387.3 192 352z"></path>
                                                            ...
                                                            <div class="sl-panel__content-wrapper sl-bg-canvas-100 example-response-GET- example-response-GET--0"
                                     style=" "
                                >
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        ...
        <div class="sl-relative">
            <div title="http://localhost/user/me"
                     class="sl-stack sl-stack--horizontal sl-stack--3 sl-inline-flex sl-flex-row sl-items-center sl-max-w-full sl-font-mono sl-py-2 sl-pr-4 sl-bg-canvas-50 sl-rounded-lg"
                >
                                            <div class="sl-text-lg sl-font-semibold sl-px-2.5 sl-py-1 sl-text-on-primary sl-rounded-lg"
                             style="background-color: green;"
                        ...
                        <div dir="rtl"
                             class="sl-overflow-x-hidden sl-truncate sl-text-muted">http://localhost</div>
                        <div class="sl-flex-1 sl-font-semibold">/user/me</div>
                    </div>
...
print_r(json_decode((string) $body));</code></pre>                                        </div>
                                ...
                                <div class="sl-flex sl-flex-1 sl-items-center sl-py-2">
                                    <div class="sl--ml-2">
                                        <div class="sl-h-sm sl-text-base sl-font-medium sl-px-1.5 sl-text-muted sl-rounded sl-border-transparent sl-border">
                                            ...
                                            <div class="sl-mb-2 sl-inline-block">
                                                <select
                                                        class="example-response-GETuser-me-toggle sl-text-base"
                                                        aria-label="Response sample"
                                                        onchange="switchExampleResponse('GETuser-me', event.target.value);">
                                        ...
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="copy"
                                            ...
                                            <path fill="currentColor"
                                                  d="M384 96L384 0h-112c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48H464c26.51 0 48-21.49 48-48V128h-95.1C398.4 128 384 113.6 384 96zM416 0v96h96L416 0zM192 352V128h-144c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48h192c26.51 0 48-21.49 48-48L288 416h-32C220.7 416 192 387.3 192 352z"></path>
                                                            ...
                                                            <div class="sl-panel__content-wrapper sl-bg-canvas-100 example-response-GETuser-me example-response-GETuser-me-0"
                                     style=" "
                                >
                                    <div class="sl-panel__content sl-p-0">                                            <details class="sl-pl-2">
                                                <summary style="cursor: pointer; list-style: none;">
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        ...
        <div class="sl-relative">
            <div title="http://localhost/user/me/history"
                     class="sl-stack sl-stack--horizontal sl-stack--3 sl-inline-flex sl-flex-row sl-items-center sl-max-w-full sl-font-mono sl-py-2 sl-pr-4 sl-bg-canvas-50 sl-rounded-lg"
                >
                                            <div class="sl-text-lg sl-font-semibold sl-px-2.5 sl-py-1 sl-text-on-primary sl-rounded-lg"
                             style="background-color: green;"
                        ...
                        <div dir="rtl"
                             class="sl-overflow-x-hidden sl-truncate sl-text-muted">http://localhost</div>
                        <div class="sl-flex-1 sl-font-semibold">/user/me/history</div>
                    </div>
                            ...
                            <div class="sl-panel__titlebar sl-flex sl-items-center sl-relative focus:sl-z-10 sl-text-base sl-leading-none sl-pr-3 sl-pl-4 sl-bg-canvas-200 sl-text-body sl-border-input focus:sl-border-primary sl-select-none">
                                <div class="sl-flex sl-flex-1 sl-items-center sl-h-lg">
                                    ...
                                    <div class="sl-px-0 sl-py-1">
                                        <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                            <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/user/me/history" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>                                        </div>
                                    </div>
                                    ...
                                    <div class="sl-px-0 sl-py-1">
                                        <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                            <pre><code class="language-javascript">const url = new URL(
    "http://localhost/user/me/history"
);
...
fetch(url, {
    ...
    headers,
                                    ...
                                    <div class="sl-px-0 sl-py-1">
                                        <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost/user/me/history';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
print_r(json_decode((string) $body));</code></pre>                                        </div>
                                ...
                                <div class="sl-flex sl-flex-1 sl-items-center sl-py-2">
                                    <div class="sl--ml-2">
                                        <div class="sl-h-sm sl-text-base sl-font-medium sl-px-1.5 sl-text-muted sl-rounded sl-border-transparent sl-border">
                                            ...
                                            <div class="sl-mb-2 sl-inline-block">
                                                <select
                                                        class="example-response-GETuser-me-history-toggle sl-text-base"
                                                        aria-label="Response sample"
                                                        onchange="switchExampleResponse('GETuser-me-history', event.target.value);">
                                                                                                            <option value="0">401</option>
                                                                                                    </select></div>
                                        </div>
                                    </div>
                                        ...
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="copy"
                                            ...
                                            <path fill="currentColor"
                                                  d="M384 96L384 0h-112c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48H464c26.51 0 48-21.49 48-48V128h-95.1C398.4 128 384 113.6 384 96zM416 0v96h96L416 0zM192 352V128h-144c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48h192c26.51 0 48-21.49 48-48L288 416h-32C220.7 416 192 387.3 192 352z"></path>
                                                            ...
                                                            <div class="sl-panel__content-wrapper sl-bg-canvas-100 example-response-GETuser-me-history example-response-GETuser-me-history-0"
                                     style=" "
                                >
                                    <div class="sl-panel__content sl-p-0">                                            <details class="sl-pl-2">
                                                <summary style="cursor: pointer; list-style: none;">
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        ...
        <div class="sl-relative">
            <div title="http://localhost/user/me/favorites"
                     class="sl-stack sl-stack--horizontal sl-stack--3 sl-inline-flex sl-flex-row sl-items-center sl-max-w-full sl-font-mono sl-py-2 sl-pr-4 sl-bg-canvas-50 sl-rounded-lg"
                >
                                            <div class="sl-text-lg sl-font-semibold sl-px-2.5 sl-py-1 sl-text-on-primary sl-rounded-lg"
                             style="background-color: green;"
                        ...
                        <div dir="rtl"
                             class="sl-overflow-x-hidden sl-truncate sl-text-muted">http://localhost</div>
                        <div class="sl-flex-1 sl-font-semibold">/user/me/favorites</div>
                    </div>
                            ...
                            <div class="sl-panel__titlebar sl-flex sl-items-center sl-relative focus:sl-z-10 sl-text-base sl-leading-none sl-pr-3 sl-pl-4 sl-bg-canvas-200 sl-text-body sl-border-input focus:sl-border-primary sl-select-none">
                                <div class="sl-flex sl-flex-1 sl-items-center sl-h-lg">
                                    ...
                                    <div class="sl-px-0 sl-py-1">
                                        <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                            <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/user/me/favorites" \
    --header "Authorization: Bearer {YOUR_AUTH_TOKEN}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre>                                        </div>
                                    </div>
                                    ...
                                    <div class="sl-px-0 sl-py-1">
                                        <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                            <pre><code class="language-javascript">const url = new URL(
    "http://localhost/user/me/favorites"
);
...
fetch(url, {
    ...
    headers,
                                    ...
                                    <div class="sl-px-0 sl-py-1">
                                        <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                            <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://localhost/user/me/favorites';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
                                ...
                                <div class="sl-flex sl-flex-1 sl-items-center sl-py-2">
                                    <div class="sl--ml-2">
                                        <div class="sl-h-sm sl-text-base sl-font-medium sl-px-1.5 sl-text-muted sl-rounded sl-border-transparent sl-border">
                                            ...
                                            <div class="sl-mb-2 sl-inline-block">
                                                <select
                                                        class="example-response-GETuser-me-favorites-toggle sl-text-base"
                                                        aria-label="Response sample"
                                                        onchange="switchExampleResponse('GETuser-me-favorites', event.target.value);">
                                                                                                            <option value="0">401</option>
                                                                                                    </select></div>
                                        </div>
                                    </div>
                                        ...
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="copy"
                                            ...
                                            <path fill="currentColor"
                                                  d="M384 96L384 0h-112c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48H464c26.51 0 48-21.49 48-48V128h-95.1C398.4 128 384 113.6 384 96zM416 0v96h96L416 0zM192 352V128h-144c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48h192c26.51 0 48-21.49 48-48L288 416h-32C220.7 416 192 387.3 192 352z"></path>
                                                            ...
                                                            <div class="sl-panel__content-wrapper sl-bg-canvas-100 example-response-GETuser-me-favorites example-response-GETuser-me-favorites-0"
                                     style=" "
                                >
                                    <div class="sl-panel__content sl-p-0">                                            <details class="sl-pl-2">
                                                <summary style="cursor: pointer; list-style: none;">
